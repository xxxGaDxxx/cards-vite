//TODO оменять после проверок ссылку
                          ...
                          <table cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <tr>
                              <td align="center" style="Margin:0;padding-top:10px;padding-bottom:10px"><span
                                ...
                                style="border-style:solid;border-color:#2CB543;background:#5C68E2;border-width:0;display:inline-block;border-radius:6px;width:auto">
                                <a
                                href="http://localhost:5173/reset-password/##token##" class="es-button" target="_blank"
